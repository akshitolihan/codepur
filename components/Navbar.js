...
const Navbar = (props) => {
  ...
  return (
    <>
    <main className="">
      <div className="pb-20 md:pb-20 text-[#424242] ">
      <nav className="justify-around rounded-b-xl md:justify-around pb-[84px] w-full mx-auto flex-row fixed bg-[#FFBE6E] z-[1]">
        <nav className="justify-around rounded-b-2xl md:justify-around pb-4 w-full mx-auto flex-row fixed bg-[#ffffff] z-[1]">
          <div className={`hidden w-full md:flex justify-around pt-4 -mb-4 `}>
            <div id={extra.edu} className="px-2">
              <Link href="/" passHref>
                <div className="flex">
                  <Image className="p-4" src="/codepur-nav.svg" alt="logo" height={36} width={36} />
                  <h1 className="m-2 flex justify-center text-4xl font-[600] tracking-wider mt-2 cursor-pointer text-[#FFBE6E]">
                    codepur
                  </h1>
                </div>
              </Link>
            </div>
            <span className="hidden md:flex text-base text-[#424242] font-[600] pt-6 justify-evenly">
              <span
                className={`${
            ...
            <div className="flex p-4">
              <button className="bg-[#ffffff] px-2 py-1 text-[#424242] rounded-3xl mx-1 text-md font-semibold">
                Log in
              </button>
              <button className="bg-[#FFBE6E] px-2 py-1 text-white rounded-3xl mx-1 text-md font-semibold">
                Sign Up
              </button>
            </div>
          </div>
          ...
          {/* <div className="bg-[#FFBE6E] p-[2px] w-full my-4 rounded-b-xl fixed z-1"></div> */}
        </nav>
        </nav>
      </div>
